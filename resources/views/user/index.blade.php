...
<head>
    ...
    <title>Spectr Magazine</title>

    <meta name="keywords" content="HTML5 Template" />
    <meta name="description" content="Responsive HTML5 Template" />

    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="57x57" href="../s3.amazonaws.com/weblionmedia-spectr/img/favicon/apple-icon-57x57.png" />
    <link rel="apple-touch-icon" sizes="60x60" href="../s3.amazonaws.com/weblionmedia-spectr/img/favicon/apple-icon-60x60.png" />
    <link rel="apple-touch-icon" sizes="72x72" href="../s3.amazonaws.com/weblionmedia-spectr/img/favicon/apple-icon-72x72.png" />
    <link rel="apple-touch-icon" sizes="76x76" href="../s3.amazonaws.com/weblionmedia-spectr/img/favicon/apple-icon-76x76.png" />
    <link rel="apple-touch-icon" sizes="114x114" href="../s3.amazonaws.com/weblionmedia-spectr/img/favicon/apple-icon-114x114.png" />
    <link rel="apple-touch-icon" sizes="120x120" href="../s3.amazonaws.com/weblionmedia-spectr/img/favicon/apple-icon-120x120.png" />
    <link rel="apple-touch-icon" sizes="144x144" href="../s3.amazonaws.com/weblionmedia-spectr/img/favicon/apple-icon-144x144.png" />
    <link rel="apple-touch-icon" sizes="152x152" href="../s3.amazonaws.com/weblionmedia-spectr/img/favicon/apple-icon-152x152.png" />
    <link rel="apple-touch-icon" sizes="180x180" href="../s3.amazonaws.com/weblionmedia-spectr/img/favicon/apple-icon-180x180.png" />
    <link rel="icon" type="image/png" sizes="192x192"  href="../s3.amazonaws.com/weblionmedia-spectr/img/favicon/android-icon-192x192.png" />
    <link rel="icon" type="image/png" sizes="32x32" href="../s3.amazonaws.com/weblionmedia-spectr/img/favicon/favicon-32x32.png" />
    <link rel="icon" type="image/png" sizes="96x96" href="../s3.amazonaws.com/weblionmedia-spectr/img/favicon/favicon-96x96.png" />
    <link rel="icon" type="image/png" sizes="16x16" href="../s3.amazonaws.com/weblionmedia-spectr/img/favicon/favicon-16x16.png" />
    <link rel="manifest" href="../s3.amazonaws.com/weblionmedia-spectr/img/favicon/manifest.json" />
    ...
    <!-- Web Fonts  -->
	<link href='../fonts.googleapis.com/cssce56.css?family=Noto+Sans:400,700,400italic,700italic%7CInconsolata:400,700%7CMontserrat:400,700' rel='stylesheet' type='text/css' />
    ...
    <div class="main-wrapper">
        ...
        <header class="header-mb">
            <div class="container">
                ...
                <div class="hdm-logo">
                    <h1><a href="index.html"><img src="../s3.amazonaws.com/weblionmedia-spectr/img/logo-mb.svg" height="40" width="140" alt="Spectr" class="adaptive" /></a></h1>
                </div>
                    ...
                    <div class="row">
                        <nav class="main-nav">
                            ...
                            <ul class="main-nav-list sf-menu">
                                ...
                                <li>
                                    <a href="javascript:void(0)">features <i class="fa fa-angle-down"></i></a>
                                    <ul class="sub">
                                        <li>
                                            <a href="#">Header variations</a>
                                            <ul class="sub">
                                                <li><a href="home_style_five.html">Header Style One</a></li>
                                                <li><a href="home_style_two.html">Header Style Two</a></li>
                                                <li><a href="home_style_three.html">Header Style Three</a></li>
                                                <li><a href="home_style_four.html">Header Style Four</a></li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="#">Home Page Styles</a>
                                            <ul class="sub">
                                                <li><a href="index-2.html">Home Page Style One</a></li>
                                                <li><a href="home_style_two.html">Home Page Style Two</a></li>
                                                <li><a href="home_style_three.html">Home Page Style Three</a></li>
                                                <li><a href="home_style_four.html">Home Page Style Four</a></li>
                                                <li><a href="home_style_five.html">Home Page Style Five</a></li>
                                                <li><a href="home_style_six.html">Home Page Style Six</a></li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="#">Category Styles</a>
                                            <ul class="sub">
                                                <li><a href="category_style_one.html">Category Style One</a></li>
                                                <li><a href="category_style_two.html">Category Style Two</a></li>
                                                <li><a href="category_style_three.html">Category Style Three</a></li>
                                                <li><a href="category_style_four.html">Category Style Four</a></li>
                                                <li><a href="category_style_five.html">Category Style Five</a></li>
                                                <li><a href="category_style_six.html">Category Style Six</a></li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="#">Featured Post layouts</a>
                                            <ul class="sub">
                                                <li><a href="post_template_one.html">Post Template One</a></li>
                                                <li><a href="post_template_two.html">Post Template Two</a></li>
                                                <li><a href="post_template_three.html">Post Template Three</a></li>
                                                <li><a href="post_template_four.html">Post Template Four</a></li>
                                                <li><a href="post_template_five.html">Post Template Five</a></li>
                                                <li><a href="post_template_six.html">Post Template Six</a></li>
                                                <li><a href="post_template_seven.html">Post Template Seven</a></li>
                                                <li><a href="post_template_eight.html">Post Template Eigth</a></li>
                                                <li><a href="post_template_nine.html">Post Template Nine</a></li>
                                            </ul>
                                        </li>
                                        <li>
                                            ...
                                            <ul class="sub">
                                                ...
                                                <li><a href="the_team_without_sidebar.html">The Team Without Sidebar</a></li>
                                                <li><a href="contact_page_style_1.html">Contact Page Style One</a></li>
                                                <li><a href="contact_page_style_2.html">Contact Page Style Two</a></li>
                                ...
                                <li><a href="category_style_six.html">design</a></li>
                                <li class="mf">
                                    <a href="#">life style <i class="fa fa-angle-down"></i></a>
                                    <ul class="sub">
                                        <li>
                                            <div class="mega-menu">
                                                <div class="col-row">
                                                            ...
                                                            <div class="col-row">
                                                                <div class="col-one-quarter">
                                                                    <article class="post">
                                                                        <figure>
                                                                            <a href="#">
                                                                                <img src="../s3.amazonaws.com/weblionmedia-spectr/img/203x136/1.jpg" height="136" width="203" alt="Spectr News Theme" class="adaptive" />
                                                                            </a>
                                                                        </figure>
                                                                ...
                                                                <div class="col-one-quarter">
                                                                    <article class="post">
                                                                        <figure>
                                                                            <a href="#">
                                                                                <img src="../s3.amazonaws.com/weblionmedia-spectr/img/203x136/2.jpg" height="136" width="203" alt="Spectr News Theme" class="adaptive" />
                                                                            </a>
                                                                        </figure>
                                                                ...
                                                                <div class="col-one-quarter">
                                                                    <article class="post">
                                                                        <figure>
                                                                            <a href="#">
                                                                                <img src="../s3.amazonaws.com/weblionmedia-spectr/img/203x136/3.jpg" height="136" width="203" alt="Spectr News Theme" class="adaptive" />
                                                                            </a>
                                                                        </figure>
                                                                ...
                                                                <div class="col-one-quarter">
                                                                    <article class="post">
                                                                        <figure>
                                                                            <a href="#">
                                                                                <img src="../s3.amazonaws.com/weblionmedia-spectr/img/203x136/4.jpg" height="136" width="203" alt="Spectr News Theme" class="adaptive" />
                                                                            </a>
                                                                        </figure>
                                ...
                                <li>
                                    ...
                                    <ul class="sub">
                                        <li><a href="review_percent_style.html">Reviews percent</a></li>
                                        <li><a href="reviews_point_style.html">Reviews points</a></li>
                                        <li><a href="reviews_stars_style.html">Reviews Stars</a></li>
                                    </ul>
                                </li>
                                <li>
                ...
                <div class="mh-top">
                    <div class="container">
                        <div class="row flex">
                            <div class="mh-logo">
                                <a href="index.html">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/main-logo.svg" height="40" width="140" alt="Spectr News Theme" class="adaptive" />
                                </a>
                            </div>
                            <div class="mh-banner">
                                <img src="../s3.amazonaws.com/weblionmedia-spectr/img/mh-banner.jpg" height="90" width="728" alt="Spectr News Theme" class="adaptive" />
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="js-main-slider-2">
                                        <div class="slide">
                                            <article class="post post-tp-1">
                                                <figure>
                                                    <a href="#"><img src="../s3.amazonaws.com/weblionmedia-spectr/img/760x471/1.jpg" height="471" width="760" alt="Spectr News Theme" class="adaptive" /></a>
                                                </figure>
                                        ...
                                        <div class="slide">
                                            <article class="post post-tp-1">
                                                <figure>
                                                    <a href="#"><img src="../s3.amazonaws.com/weblionmedia-spectr/img/760x471/2.jpg" height="471" width="760" alt="Spectr News Theme" class="adaptive" /></a>
                                                </figure>
                                                <div class="ptp-1-overlay">
                                                    <div class="ptp-1-data">
                                                        <a href="#" class="category-tp-1">BUSINESS</a>
                                        ...
                                        <div class="slide">
                                            <article class="post post-tp-1">
                                                <figure>
                                                    <a href="#"><img src="../s3.amazonaws.com/weblionmedia-spectr/img/760x471/3.jpg" height="471" width="760" alt="Spectr News Theme" class="adaptive" /></a>
                                                </figure>
                                                <div class="ptp-1-overlay">
                                                    <div class="ptp-1-data">
                                                        <a href="#" class="category-tp-1">BUSINESS</a>
                                            ...
                                            <div class="js-trend-pst-slider">
                                                <div>
                                                    <article class="post post-tp-3">
                                                        <figure>
                                                            <a href="#"><img src="../s3.amazonaws.com/weblionmedia-spectr/img/126x98/1.jpg" height="98" width="126" alt="Spectr News Theme" class="adaptive" /></a>
                                                        </figure>
                                                    ...
                                                    <article class="post post-tp-3">
                                                        <figure>
                                                            <a href="#"><img src="../s3.amazonaws.com/weblionmedia-spectr/img/126x98/2.jpg" height="98" width="126" alt="Spectr News Theme" class="adaptive" /></a>
                                                        </figure>
                                                    ...
                                                    <article class="post post-tp-3">
                                                        <figure>
                                                            <a href="#"><img src="../s3.amazonaws.com/weblionmedia-spectr/img/126x98/3.jpg" height="98" width="126" alt="Spectr News Theme" class="adaptive" /></a>
                                                        </figure>
                        ...
                        <div class="mp-section">
                            <div class="one-third sm-half xs-full">
                                <article class="post post-tp-2">
                                    <figure>
                                        <a href="#"><img src="../s3.amazonaws.com/weblionmedia-spectr/img/380x258/1.jpg" height="258" width="380" alt="Spectr News Theme" class="adaptive" /></a>
                                    </figure>
                                    <div class="ptp-1-overlay">
                                        <div class="ptp-1-data">
                                            <a href="#" class="category-tp-1">BUSINESS</a>
                            ...
                            <div class="one-third sm-half xs-hide">
                                <article class="post post-tp-2">
                                    <figure>
                                        <a href="#"><img src="../s3.amazonaws.com/weblionmedia-spectr/img/380x258/2.jpg" height="258" width="380" alt="Spectr News Theme" class="adaptive" /></a>
                                    </figure>
                                    <div class="ptp-1-overlay">
                                        <div class="ptp-1-data">
                            ...
                            <div class="one-third sm-hide">
                                <article class="post post-tp-2">
                                    <figure>
                                        <a href="#"><img src="../s3.amazonaws.com/weblionmedia-spectr/img/380x258/3.jpg" height="258" width="380" alt="Spectr News Theme" class="adaptive" /></a>
                                    </figure>
                                    <div class="ptp-1-overlay">
                                        <div class="ptp-1-data">
                                            <a href="#" class="category-tp-1">life style</a>
                                    ...
                                    <div class="col-row">
                                        <div class="col-one-quarter">
                                            <article class="post post-tp-4">
                                                <figure>
                                                    <a href="#">
                                                        <img src="../s3.amazonaws.com/weblionmedia-spectr/img/260x186/1.jpg" height="186" width="260" alt="Spectr News Theme" class="adaptive" />
                                                    </a>
                                        ...
                                        <div class="col-one-quarter">
                                            <article class="post post-tp-4">
                                                <figure>
                                                    <a href="#">
                                                        <img src="../s3.amazonaws.com/weblionmedia-spectr/img/260x186/2.jpg" height="186" width="260" alt="Spectr News Theme" class="adaptive" />
                                                    </a>
                                                    <div class="ptp-4-overlay">
                                                        <div class="ptp-4-data">
                                                            <a href="#">
                                        ...
                                        <div class="col-one-quarter">
                                            <article class="post post-tp-4">
                                                <figure>
                                                    <a href="#">
                                                        <img src="../s3.amazonaws.com/weblionmedia-spectr/img/260x186/3.jpg" height="186" width="260" alt="Spectr News Theme" class="adaptive" />
                                                    </a>
                                                    <div class="ptp-4-overlay">
                                                        <div class="ptp-4-data">
                                                            <a href="#">
                                        ...
                                        <div class="col-one-quarter">
                                            <article class="post post-tp-4">
                                                <figure>
                                                    <a href="#">
                                                        <img src="../s3.amazonaws.com/weblionmedia-spectr/img/260x186/4.jpg" height="186" width="260" alt="Spectr News Theme" class="adaptive" />
                                                    </a>
                                                    <div class="ptp-4-overlay">
                                                        <div class="ptp-4-data">
                                                            <a href="#">
                ...
                <div class="col-row">
                    <div class="col-half">
                        <article class="post post-tp-5">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/345x242/1.jpg" height="242" width="345" alt="Spectr News Theme" class="adaptive" />
                                </a>
                            </figure>
                    ...
                    <div class="col-half">
                        <article class="post post-tp-6">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/115x85/1.jpg" height="85" width="115" alt="Spectr News Theme" class="adaptive" />
                                </a>
                            </figure>
                        ...
                        <article class="post post-tp-6">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/115x85/2.jpg" height="85" width="115" alt="Spectr News Theme" class="adaptive" />
                                </a>
                            </figure>
                        ...
                        <article class="post post-tp-6">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/115x85/3.jpg" height="85" width="115" alt="Spectr News Theme" class="adaptive" />
                                </a>
                            </figure>
                        ...
                        <article class="post post-tp-6">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/115x85/4.jpg" height="85" width="115" alt="Spectr News Theme" class="adaptive" />
                                </a>
                            </figure>
                ...
                <div class="col-row">
                    <div class="col-half">
                        <article class="post post-tp-5">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/345x242/2.jpg" height="242" width="345" alt="Spectr News Theme" class="adaptive" />
                                </a>
                    ...
                    <div class="col-half">
                        <article class="post post-tp-5">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/345x242/3.jpg" height="242" width="345" alt="Spectr News Theme" class="adaptive" />
                                </a>
                                <div class="ptp-5-overlay">
                                    <div class="ptp-5-data">
                                        <a href="#">
                ...
                <div class="col-row">
                    <div class="col-half">
                        <article class="post post-tp-6">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/115x85/5.jpg" height="85" width="115" alt="Spectr News Theme" class="adaptive" />
                                </a>
                            </figure>
                            <h3 class="title-6"><a href="#">Duis eu arcu sit amet ante tristique</a></h3>
                            <div class="date-tp-2">october 2, 2015</div>
                        ...
                        <article class="post post-tp-6">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/115x85/6.jpg" height="85" width="115" alt="Spectr News Theme" class="adaptive" />
                                </a>
                            </figure>
                            <h3 class="title-6"><a href="#">Vivamus auctor quam nec mauris commodo</a></h3>
                            <div class="date-tp-2">october 2, 2015</div>
                    ...
                    <div class="col-half">
                        <article class="post post-tp-6">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/115x85/7.jpg" height="85" width="115" alt="Spectr News Theme" class="adaptive" />
                                </a>
                            </figure>
                            <h3 class="title-6"><a href="#">Nam ut metus elementum pharetra diam sed</a></h3>
                            <div class="date-tp-2">october 2, 2015</div>
                        ...
                        <article class="post post-tp-6">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/115x85/8.jpg" height="85" width="115" alt="Spectr News Theme" class="adaptive" />
                                </a>
                            </figure>
                            <h3 class="title-6"><a href="#">Mauris porta quam a lorem rhoncus fringilla</a></h3>
                            <div class="date-tp-2">october 2, 2015</div>
                    ...
                    <div class="js-pst-block">
                        <div class="col-one-third">
                            <article class="post post-tp-5">
                                <figure>
                                    <a href="#">
                                        <img src="../s3.amazonaws.com/weblionmedia-spectr/img/224x150/1.jpg" height="150" width="224" alt="Spectr News Theme" class="adaptive" />
                                    </a>
                                </figure>
                        ...
                        <div class="col-one-third">
                            <article class="post post-tp-5">
                                <figure>
                                    <a href="#">
                                        <img src="../s3.amazonaws.com/weblionmedia-spectr/img/224x150/2.jpg" height="150" width="224" alt="Spectr News Theme" class="adaptive" />
                                    </a>
                                </figure>
                        ...
                        <div class="col-one-third">
                            <article class="post post-tp-5">
                                <figure>
                                    <a href="#">
                                        <img src="../s3.amazonaws.com/weblionmedia-spectr/img/224x150/3.jpg" height="150" width="224" alt="Spectr News Theme" class="adaptive" />
                                    </a>
                                </figure>
                                <h3 class="title-5"><a href="#">Fusce ac orci sagittis mattis magna ultrices</a></h3>
                                <div class="date-tp-2"><span>october 2, 2015</span></div>
...
<aside class="side-bar">
    ...
    <div class="sb-banner">
        <div class="banner-inner">
            <img src="../s3.amazonaws.com/weblionmedia-spectr/img/sb-banner-img.jpg" height="270" width="320" alt="Spectr News Theme" class="adaptive" />
                ...
                <div class="js-csp-block js-tab-slider">
                    <div>
                        <article class="post post-tp-9">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/115x85/9.jpg" alt="Spectr News Theme" class="adaptive" height="85" width="115">
                                </a>
                            </figure>
                            <h3 class="title-6"><a href="#">Duis eu arcu sit amet ante tristique</a></h3>
                            <div class="date-tp-2">october 2, 2015</div>
                        ...
                        <article class="post post-tp-9">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/115x85/10.jpg" alt="Spectr News Theme" class="adaptive" height="85" width="115">
                                </a>
                            </figure>
                            <h3 class="title-6"><a href="#">Vivamus auctor quam nec mauris commodo</a></h3>
                            <div class="date-tp-2">october 2, 2015</div>
                        ...
                        <article class="post post-tp-9">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/115x85/11.jpg" alt="Spectr News Theme" class="adaptive" height="85" width="115">
                                </a>
                            </figure>
                            <h3 class="title-6"><a href="#">Nam ut metus elementum pharetra diam sed</a></h3>
                            <div class="date-tp-2">october 2, 2015</div>
                    ...
                    <div class="js-sbr-slider">
                        <div class="item">
                            <article class="post post-tp-10">
                                <figure>
                                    <a href="#">
                                        <img src="../s3.amazonaws.com/weblionmedia-spectr/img/360x231/1.jpg" alt="Spectr News Theme" class="adaptive" height="231" width="360">
                                    </a>
                        ...
                        <div class="item">
                            <article class="post post-tp-10">
                                <figure>
                                    <a href="#">
                                        <img src="../s3.amazonaws.com/weblionmedia-spectr/img/360x231/2.jpg" alt="Spectr News Theme" class="adaptive" height="231" width="360">
                                    </a>
                                    <a href="#" class="category-tp-1">Home</a>
                                </figure>
                                <div class="ptp-10-data">
                        ...
                        <div class="item">
                            <article class="post post-tp-10">
                                <figure>
                                    <a href="#">
                                        <img src="../s3.amazonaws.com/weblionmedia-spectr/img/360x231/3.jpg" alt="Spectr News Theme" class="adaptive" height="231" width="360">
                                    </a>
                                    <a href="#" class="category-tp-1">Home</a>
                                </figure>
                                <div class="ptp-10-data">
                                        ...
                                        <div class="vps-item">
                                            <div class="half sm-full mb-pt-hide">
                                                <article class="post post-tpv-1">
                                                    <figure>
                                                        <a href="#"><img src="../s3.amazonaws.com/weblionmedia-spectr/img/570x430/1.jpg" height="430" width="570" alt="Spectr News Theme" class="adaptive" /></a>
                                                    </figure>
                                                    <div class="ptp-1-overlay">
                                            ...
                                            <div class="half sm-full">
                                                <div class="half">
                                                    <article class="post post-tpv-2">
                                                        <figure>
                                                            <a href="#"><img src="../s3.amazonaws.com/weblionmedia-spectr/img/285x215/1.jpg" height="215" width="285" alt="Spectr News Theme" class="adaptive" /></a>
                                                        </figure>
                                                        <div class="ptp-1-overlay">
                                                            <div class="ptp-1-data">
                                                ...
                                                <div class="half">
                                                    <article class="post post-tpv-2">
                                                        <figure>
                                                            <a href="#"><img src="../s3.amazonaws.com/weblionmedia-spectr/img/285x215/2.jpg" height="215" width="285" alt="Spectr News Theme" class="adaptive" /></a>
                                                        </figure>
                                                        <div class="ptp-1-overlay">
                                                            <div class="ptp-1-data">
                                                                <span class="arr-left-light-sm-ic video-sm-ic"><i></i></span>
                                                ...
                                                <div class="half">
                                                    <article class="post post-tpv-2">
                                                        <figure>
                                                            <a href="#"><img src="../s3.amazonaws.com/weblionmedia-spectr/img/285x215/3.jpg" height="215" width="285" alt="Spectr News Theme" class="adaptive" /></a>
                                                        </figure>
                                                        <div class="ptp-1-overlay">
                                                            <div class="ptp-1-data">
                                                                <span class="arr-left-light-sm-ic video-sm-ic"><i></i></span>
                                                ...
                                                <div class="half">
                                                    <article class="post post-tpv-2">
                                                        <figure>
                                                            <a href="#"><img src="../s3.amazonaws.com/weblionmedia-spectr/img/285x215/4.jpg" height="215" width="285" alt="Spectr News Theme" class="adaptive" /></a>
                                                        </figure>
                                                        <div class="ptp-1-overlay">
                                                            <div class="ptp-1-data">
                                                                <span class="arr-left-light-sm-ic video-sm-ic"><i></i></span>
                    ...
                    <div class="js-pst-block" data-items="2">
                        <div class="col-half">
                            <article class="post post-tp-7">
                                <figure>
                                    <a href="#">
                                        <img src="../s3.amazonaws.com/weblionmedia-spectr/img/68x80/1.jpg" height="80" width="68" alt="Spectr News Theme">
                                    </a>
                                </figure>
                                <div class="date-tp-2"><span>october 2, 2015</span></div>
                                <h3 class="title-5"><a href="#">Fusce ac orci sagittis mattis magna ultrices libero</a></h3>
                        ...
                        <div class="col-half">
                            <article class="post post-tp-7">
                                <figure>
                                    <a href="#">
                                        <img src="../s3.amazonaws.com/weblionmedia-spectr/img/68x80/2.jpg" height="80" width="68" alt="Spectr News Theme">
                                    </a>
                                </figure>
                                <div class="date-tp-2"><span>october 2, 2015</span></div>
                ...
                <div class="col-row">
                    <div class="col-half">
                        <article class="post post-tp-8">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/345x242/4.jpg" height="242" width="345" alt="Spectr News Theme" class="adaptive" />
                                </a>
                    ...
                    <div class="col-half">
                        <article class="post post-tp-8">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/345x242/5.jpg" height="242" width="345" alt="Spectr News Theme" class="adaptive" />
                                </a>
                                <div class="ptp-8-overlay">
                                    <div class="ptp-8-data">
                                        <a href="#">
                    ...
                    <div class="col-half">
                        <article class="post post-tp-8">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/345x242/6.jpg" height="242" width="345" alt="Spectr News Theme" class="adaptive" />
                                </a>
                                <div class="ptp-8-overlay">
                                    <div class="ptp-8-data">
                                        <a href="#">
                    ...
                    <div class="col-half">
                        <article class="post post-tp-8">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/345x242/7.jpg" height="242" width="345" alt="Spectr News Theme" class="adaptive" />
                                </a>
                                <div class="ptp-8-overlay">
                                    <div class="ptp-8-data">
                                        <a href="#">
                    ...
                    <div class="col-half">
                        <article class="post post-tp-8">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/345x242/8.jpg" height="242" width="345" alt="Spectr News Theme" class="adaptive" />
                    ...
                    <div class="col-half">
                        <article class="post post-tp-8">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/345x242/9.jpg" height="242" width="345" alt="Spectr News Theme" class="adaptive" />
                                </a>
                                <div class="ptp-8-overlay">
                                    <div class="ptp-8-data">
                                        <a href="#">
                    ...
                    <div class="col-half">
                        <article class="post post-tp-8">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/345x242/10.jpg" height="242" width="345" alt="Spectr News Theme" class="adaptive" />
                                </a>
                                <div class="ptp-8-overlay">
                                    <div class="ptp-8-data">
                                        <a href="#">
                    ...
                    <div class="col-half">
                        <article class="post post-tp-8">
                            <figure>
                                <a href="#">
                                    <img src="../s3.amazonaws.com/weblionmedia-spectr/img/345x242/11.jpg" height="242" width="345" alt="Spectr News Theme" class="adaptive" />
                                </a>
                                <div class="ptp-8-overlay">
                                    <div class="ptp-8-data">
                                        <a href="#">
                ...
                <div class="js-csp-block">
                    <div>
                        <figure class="full-img">
                            <a href="#">
                                <img src="../s3.amazonaws.com/weblionmedia-spectr/img/360x245/1.jpg" alt="Spectr News Theme" class="adaptive" height="245" width="360">
                            </a>
                        ...
                        <div class="post-wrap">
                            ...
                            <article class="post post-tp-6">
                                <figure>
                                    <a href="#">
                                        <img src="../s3.amazonaws.com/weblionmedia-spectr/img/115x85/12.jpg" alt="Spectr News Theme" class="adaptive" height="85" width="115">
                                    </a>
                                </figure>
                                <h3 class="title-6"><a href="#">Duis eu arcu sit amet ante tristique</a></h3>
                                <div class="rate-tp-1">
                            ...
                            <article class="post post-tp-6">
                                <figure>
                                    <a href="#">
                                        <img src="../s3.amazonaws.com/weblionmedia-spectr/img/115x85/13.jpg" alt="Spectr News Theme" class="adaptive" height="85" width="115">
                                    </a>
                                </figure>
                ...
                <footer class="main-footer">
                    <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="one-third sm-full">
                                    <div class="ft-widget">
                                        ...
                                        <ul class="ft-list-2">
                                            <li>
                                                <figure>
                                                    <a href="#"><img src="../s3.amazonaws.com/weblionmedia-spectr/img/115x85/14.jpg" height="85" width="115" alt="Spectr News Theme"></a>
                                                </figure>
                                            ...
                                            <li>
                                                <figure>
                                                    <a href="#"><img src="../s3.amazonaws.com/weblionmedia-spectr/img/115x85/15.jpg" height="85" width="115" alt="Spectr News Theme"></a>
                                                </figure>
                                            ...
                                            <li>
                                                <figure>
                                                    <a href="#"><img src="../s3.amazonaws.com/weblionmedia-spectr/img/115x85/16.jpg" height="85" width="115" alt="Spectr News Theme"></a>
                                                </figure>
                                ...
                                <div class="one-third sm-full">
                                    ...
                                    <div class="ft-widget">
                                        ...
                                        <ul class="inst-list">
                                            <li><a href="#">
                                                <img src="../s3.amazonaws.com/weblionmedia-spectr/img/68x68/1.jpg" height="68" width="68" class="adaptive" alt="Spectr News Theme">
                                            </a></li>
                                            <li><a href="#">
                                                <img src="../s3.amazonaws.com/weblionmedia-spectr/img/68x68/2.jpg" height="68" width="68" class="adaptive" alt="Spectr News Theme">
                                            </a></li>
                                            <li><a href="#">
                                                <img src="../s3.amazonaws.com/weblionmedia-spectr/img/68x68/3.jpg" height="68" width="68" class="adaptive" alt="Spectr News Theme">
                                            </a></li>
                                            <li><a href="#">
                                                <img src="../s3.amazonaws.com/weblionmedia-spectr/img/68x68/4.jpg" height="68" width="68" class="adaptive" alt="Spectr News Theme">
                                            </a></li>
                                            <li><a href="#">
                                                <img src="../s3.amazonaws.com/weblionmedia-spectr/img/68x68/5.jpg" height="68" width="68" class="adaptive" alt="Spectr News Theme">
                                            </a></li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="bottom-part">
                            <div class="row">
                                <div class="ft-logo">
                                    <a href="#"><img src="../s3.amazonaws.com/weblionmedia-spectr/img/footer-logo.svg" height="30" width="105" alt="Spectr News Theme"></a>
                                </div>
                                <div class="ft-about">
                                    <article>
        ...
        <div class="container">
            <nav class="mobile-nav">
                <ul class="mobile-nav-list">
                    <li class="mn-item"><a href="index-2.html">news</a></li>
...
<!-- Mirrored from spectr-html.weblionmedia.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 May 2018 06:13:01 GMT -->
</html>
